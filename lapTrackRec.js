...
var RTAServer = "http://localhost:3005";
...
client.on('message', function(room, message) {
    ...
    if (startFlag === 1) {
        ...
        if (room === carEP) {
            console.log("change Engine Power received:");
        ...
        if (String(message) === "lap") {
            console.log("laptime received from: " + room);
                ...
                if (lapNoCar01 < numLapsMax) {
                    ...
                    rp(options)
                        .then(function(parsedBody) {
                            console.log('post laptime success');
                        })
                        .catch(function(err) {
                            console.error('post laptime', err);
                        });
